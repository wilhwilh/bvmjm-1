...
<table class="table">
	...
	<tr>
		...
		<td>
			<?php
			if (isset($c031['f'])) {
				echo $this->Form->input('031f', array('id' => '031f', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c031['f']));
			} else {
				echo $this->Form->input('031f', array('id' => '031f', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
...
<?php $c5922 = marc21_decode($item['Item']['5922']); ?>
<table class="table">
	<tr>
		<th style="width: 5%;"><b>592/2</b></th>
		<th style="width: 45%;"><b>Notas al íncipit musical.</b></th>
		<th style="width: 45%;">
			<label id="l-5922"><?php echo $item['Item']['5922']; ?></label>
			<?php echo $this->Form->hidden('5922', array('id' => '5922', 'label' => false, 'div' => false, 'value' => $item['Item']['5922'])); ?>
		</th>
	</tr>
	<tr>
		<td><b>$b</b></td>
		...
		<td>
			<?php
			if (isset($c5922['b'])) {
				echo $this->Form->input('5922a', array('id' => '5922a', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c5922['b']));
			} else {
				echo $this->Form->input('5922a', array('id' => '5922a', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c5922['c'])) {
				echo $this->Form->input('5922c', array('id' => '5922c', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c5922['c']));
			} else {
				echo $this->Form->input('5922c', array('id' => '5922c', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c5922['f'])) {
				echo $this->Form->input('5922f', array('id' => '5922f', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c5922['f']));
			} else {
				echo $this->Form->input('5922f', array('id' => '5922f', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
	<tr>
		...
		<td>
			<?php
			if (isset($c5922['g'])) {
				echo $this->Form->input('5922g', array('id' => '5922g', 'label' => false, 'div' => false, 'class' => 'form-control', 'value' => $c5922['g']));
			} else {
				echo $this->Form->input('5922g', array('id' => '5922g', 'label' => false, 'div' => false, 'class' => 'form-control'));
			}
			?>
		</td>
	</tr>
